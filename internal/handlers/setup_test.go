...
func getRoutes() http.Handler {
	...
	//Already tested in middleware
	//mux.Use(NoSurf)
	mux.Use(SessionLoad)

	mux.Get("/", Repo.Home)
	mux.Get("/about", Repo.About)
	mux.Get("/nebula", Repo.Nebula)
	mux.Get("/darkfathom", Repo.Darkfathom)
	...
	//No wrapper needed, not testing authentication
	//But need to add prefix 'admin' since not grouped
