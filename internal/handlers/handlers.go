...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		m.App.Session.Put(r.Context(), "error", "can't parse start date: invalid data!")
		http.Redirect(w, r, "/", http.StatusSeeOther)
		return
	}
	...
	if err != nil {
		m.App.Session.Put(r.Context(), "error", "can't parse end date: invalid data!")
		http.Redirect(w, r, "/", http.StatusSeeOther)
		return
	}
	...
	if err != nil {
		m.App.Session.Put(r.Context(), "error", "can't parse roomID: invalid data!")
		http.Redirect(w, r, "/", http.StatusSeeOther)
		return
	}
